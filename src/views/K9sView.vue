...
const { query, filteredSections } = useSearch(k9sTopic.sections)
const { activeId } = useToc(k9sTopic.sections)
...
<template>
  <MobileHeader :title="k9sTopic.title" @toggle-sidebar="toggle" />
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="lg:flex lg:gap-8">
      ...
      <div class="flex-1 min-w-0">
        <HeroSection :title="k9sTopic.heroTitle" :desc="k9sTopic.heroDesc" />
