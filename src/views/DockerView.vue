...
const { query, filteredSections } = useSearch(dockerTopic.sections)
const { activeId } = useToc(dockerTopic.sections)
...
<template>
  <MobileHeader :title="dockerTopic.title" @toggle-sidebar="toggle" />
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="lg:flex lg:gap-8">
      ...
      <div class="flex-1 min-w-0">
        <HeroSection :title="dockerTopic.heroTitle" :desc="dockerTopic.heroDesc" />
